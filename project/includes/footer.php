    ...
    <div class="main-container">
      <div class="footer-block">
        ...
        <ul class="user-navigation">
          <li class="user-navigation-item">
            <a class="user-navigation-link login-link" href="#">Sign in</a>
          </li>
          <li class="user-navigation-item">
            <a class="user-navigation-link compare-link" href="#">
              <svg class="user-navigation-icon compare-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10" enable-background="new 0 0 10 10" xml:space="preserve">
          ...
          <li class="user-navigation-item">
            <a class="user-navigation-link cart-link" href="#">
              <svg class="user-navigation-icon cart-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="12px" height="12px" viewBox="0 0 12 12" enable-background="new 0 0 12 12" xml:space="preserve">
                <g>
      ...
      <div class="footer-block">
        <div class="address-wrapper">
          <p class="address">Prague, W. Churchill Sq. 1938/4</p>
        </div>
        <ul class="footer-nav-list">
          <li class="nav-item"><a class="nav-link footer-nav-link delivery-link" href="#">Shipping</a></li>
          <li class="nav-item"><a class="nav-link footer-nav-link guarantee-link" href="#">Payment</a></li>
          <li class="nav-item"><a class="nav-link footer-nav-link contacts-link" href="#">Contact us</a></li>
        </ul>
        <div class="email-wrapper">
          <p class="email-text"><a class="email-link" href="mailto: idevice@help.com">idevice@help.com</a></p>
        </div>
      </div>
      <div class="footer-block">
        <section class="footer-social">
          ...
          <ul class="footer-social-list">
            <li class="footer-social-item">
              <a class="footer-social-link facebook" title="Facebook" href="https://www.facebook.com/" aria-label="Link to facebook">
              </a>
            </li>
            <li class="footer-social-item">
              <a class="footer-social-link instagram" title="Instagram" href="https://www.instagram.com" aria-label="Link to instagram">
              </a>
            </li>
            <li class="footer-social-item">
              <a class="footer-social-link twitter" title="Twitter" href="https://twitter.com/" aria-label="Link to twitter">
              </a>
            </li>
          </ul>
        </section>
